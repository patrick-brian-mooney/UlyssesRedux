...
mixin_texts_dir = '%s14' % current_run_corpus_directory

def write_story():
    return write_generic_story(chain_length, chapter_length, sentences_per_paragraph, oxen_base_text_path, mixin_texts_dir)
