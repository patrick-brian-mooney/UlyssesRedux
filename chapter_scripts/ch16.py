...
Joyce's Ulysses, 'Eumaeus.' Currently, just generates 1120 sentences based on
...
mixin_texts_dir = '%s16' % current_run_corpus_directory

def write_story():
    return write_generic_story(chain_length, chapter_length, sentences_per_paragraph, eumaeus_base_text_path, mixin_texts_dir)
