...
Ulysses, 'Lotus Eaters.' Currently, just generates 108 sentences based on the
text of 'Lotus Eaters', aiming for an average paragraph length of 6.787, which
...
joyce_base_text_path = '/UlyssesRedux/corpora/joyce/ulysses/05.txt'
chain_length = 3
chapter_length = 158                          # Measured in sentences.
